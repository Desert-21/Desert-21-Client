...
import { AppNotification, ResourcesProducedNotification } from 'src/app/models/notification-models';
...
export class ResourcesProducedNotificationComponent implements OnInit, OnDestroy {
